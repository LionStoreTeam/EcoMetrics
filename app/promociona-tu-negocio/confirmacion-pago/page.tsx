...
import PaymentConfirmationClientContent from './PaymentConfirmationClientContent'; // Importa el nuevo componente
...
function LoadingFallback() {
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-neutral-900 flex flex-col items-center justify-center p-4">
            ...
            <div className="flex flex-col items-center text-center">
                <Loader2 className="h-12 w-12 animate-spin text-green-600 mb-4" />
                <p className="text-lg text-gray-700 dark:text-gray-200">Cargando confirmación de pago...</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">Esto puede tomar un momento.</p>
            </div>
...
export default function PaymentConfirmationPageWrapper() {
    return (
        <Suspense fallback={<LoadingFallback />}>
            <PaymentConfirmationClientContent />
        </Suspense>
    );
}